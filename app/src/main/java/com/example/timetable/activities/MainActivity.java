...
import com.example.timetable.utils.DailyReceiver;

import java.util.Calendar;

import static com.example.timetable.utils.BrowserUtil.openUrlInChromeCustomTab;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void setupCustomDialog() {
        ...
        AlertDialogsHelper.getAddSubjectDialog(MainActivity.this, alertLayout, adapter, viewPager, null);
    }
    ...
    private void setDailyAlarm() {
        ...
        PendingIntent pendingIntent = PendingIntent.getBroadcast(
                this, ALARM1_ID, myIntent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
